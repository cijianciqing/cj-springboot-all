package cj.springboot2.template.mybatis.plus.util;


import cj.springboot2.template.mybatis.plus.config.CJBaseColmns;
import cj.springboot2.template.mybatis.plus.config.CJMapper;
...
public class CJCodeGenerator {
    ...
    // 包名和模块名
    private static final String PACKAGE_NAME = "cj.springboot2.template.mybatis.plus";
